...
import sys
import requests
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QListWidget, QPushButton, QMessageBox, QLineEdit, \
    QGroupBox, QHBoxLayout, QFormLayout, QScrollArea
...
class FileDownloader(QWidget):
    ...
    def get_file_list(self):
        ...
        if response.status_code == 200:
            ...
            for file_info in files_info:
                ...
                self.list_widget.setItemWidget(self.list_widget.item(self.list_widget.count() - 1), install_button)
    ...
    def update_install_buttons(self):
        for i in range(self.list_widget.count()):
            ...
            local_file_path = os.path.join("Plugins", selected_file)
    ...
    def download_file(self, file_name):
        ...
        if response.status_code == 200:
            ...
            QMessageBox.information(
                self, "Plugin Downloaded", f"Plugin '{selected_file}' has been downloaded successfully."
            )
