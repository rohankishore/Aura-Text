...
def check_for_issues():
    ...
    if check_file_in_directory(menu_file):
        ...
        messagebox.showerror(
            "File not found",
            f"The file '{menu_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )
    ...
    if check_file_in_directory(tab_file):
        ...
        messagebox.showerror(
            "File not found",
            f"The file '{tab_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )

    if check_file_in_directory(terminal_file):
        messagebox.showinfo(
            "File is there!", f"The file '{terminal_file}' exists in the directory."
        )
    else:
        messagebox.showerror(
            "File not found",
            f"The file '{terminal_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )

    if check_file_in_directory(welcomescreen_file):
        messagebox.showinfo(
            "File is there!", f"The file '{welcomescreen_file}' exists in the directory."
        )
    else:
        messagebox.showerror(
            "File not found",
            f"The file '{welcomescreen_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )
    ...
    if check_file_in_directory(module_file):
        ...
        messagebox.showerror(
            "File not found",
            f"The file '{module_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )

    if check_file_in_directory(config_page_file):
        messagebox.showinfo(
            "File is there!", f"The file '{config_page_file}' exists in the directory."
        )
    else:
        messagebox.showerror(
            "File not found",
            f"The file '{config_page_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )
    ...
    if check_file_in_directory(lexers_file):
        ...
        messagebox.showerror(
            "File not found",
            f"The file '{lexers_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )
    ...
    if check_file_in_directory(cpath_file):
        ...
        messagebox.showerror(
            "File not found",
            f"The file '{cpath_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )

    if check_file_in_directory(json_config_file):
        messagebox.showinfo(
            "File is there!", f"The file '{json_config_file}' exists in the directory."
        )
    else:
        messagebox.showerror(
            "File not found",
            f"The file '{json_config_file}' does not exist in the directory. Please re-install Aura Text from the Official GitHub Repo ('? -> GitHub')",
        )
